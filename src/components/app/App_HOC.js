...
const FirstFetchWithSlider = withSlider(SliderFirst, getDataFromFirstFetch);
const SecondFetchWithSlider = withSlider(SliderSecond,getDataFromSecondFetch);
...
function App() {
    return (
        <>  
            ...
            <FirstFetchWithSlider/>
            <SecondFetchWithSlider/>
        </>
    );
}
